"""Discover sprite_worker.py instances advertised via Bonjour/mDNS on the LAN.

Browses for "_sprite-worker._tcp.local." services for a few seconds and
...
resolve mDNS names. Used by setup_main.sh to auto-configure SPRITE_WORKERS.

Usage:
    python scripts/discover_worker.py [timeout_seconds]
"""
